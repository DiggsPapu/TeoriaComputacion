     ...
     public static void main(String[] args)
    {
		...
		try {
			...
			while (line != null) {
                ...
                while (true)
                {
                    System.out.println("Enter a chain to determine whether it is accepted by the AFN");
                ...
                while (true)
                {
                    System.out.println("Enter a chain to determine whether it is accepted by afd");
                    if (afn.isAcceptedByAFD(scanner.nextLine(), false)) {
                        System.out.println("w∈L(r)?\nYes");
                    }
                    else {
                        System.out.println("No");
                ...
                while (true) {
                    System.out.println("Enter a chain to determine whether it is accepted by afd simplified");
                    if (afn.isAcceptedByAFD(scanner.nextLine(), true)) {
                        System.out.println("w∈L(r)?\nYes");
                    }
                    else {
                        System.out.println("No");
